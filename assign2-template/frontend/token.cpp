...
Token Token::makeId(std::string name) {
  return Token(TokenType::Id, name);
}
Token Token::makeNum(int value) {
  return Token(TokenType::Num, value);
}
Token Token::makeType(std::string name) {
  return Token(TokenType::Type, name);
}
Token Token::makeIf() {
  return Token(TokenType::If);
}
Token Token::makeElse() {
  return Token(TokenType::Else);
}
Token Token::makeWhile() {
  return Token(TokenType::While);
}
Token Token::makeDef() {
  return Token(TokenType::Def);
}
Token Token::makeReturn() {
  return Token(TokenType::Return);
}
Token Token::makeOutput() {
  return Token(TokenType::Output);
}
Token Token::makeArithOp(ArithOp op) {
  return Token(TokenType::ArithOp, op);
}
Token Token::makeRelOp(RelOp op) {
  return Token(TokenType::RelOp, op);
}
Token Token::makeLBinOp(LBinOp op) {
  return Token(TokenType::LBinOp, op);
}
Token Token::makeLNeg() {
  return Token(TokenType::LNeg);
}
...
Token Token::makeLBrace() {
  return Token(TokenType::LBrace);
}
Token Token::makeRBrace() {
  return Token(TokenType::RBrace);
}
Token Token::makeSemicolon() {
  return Token(TokenType::Semicolon);
}
Token Token::makeAssign() {
  return Token(TokenType::Assign);
}
Token Token::makeHasType() {
  return Token(TokenType::HasType);
}
Token Token::makeComma() {
  return Token(TokenType::Comma);
}
Token Token::makeRBracket() {
  return Token(TokenType::RBracket);
}
Token Token::makeLBracket() {
  return Token(TokenType::LBracket);
}
Token Token::makeFor() {
  return Token(TokenType::For);
}
Token Token::makeFrom() {
